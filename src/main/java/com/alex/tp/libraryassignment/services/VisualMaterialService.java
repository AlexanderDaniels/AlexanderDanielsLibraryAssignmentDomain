 ...
 * @author Alex
 */
public class VisualMaterialService {
    private String id;
    private String typeOfVisualMaterial;
    private String nameOfVisualMaterial;

    public VisualMaterialService(VisualMaterialBuilder builder) {
        this.id = builder.id;
    ...
    public static class VisualMaterialBuilder{
        ...
        public VisualMaterialBuilder visualMaterial(VisualMaterialService visualMaterial){
        ...
        public VisualMaterialService build(){
            return new VisualMaterialService(this);
        }        
    }
    ...
    public boolean equals(Object obj) {
        ...
        final VisualMaterialService other = (VisualMaterialService) obj;
        return true;
    }
